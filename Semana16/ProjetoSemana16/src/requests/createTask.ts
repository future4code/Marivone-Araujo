...
// {
//   "message": "INSERT INTO todolist_task (id, title, description, deadline, author_id)\n          VALUES(\n          \"undefined\",\n          \"undefined\",\n          \"undefined\",\n          \"Invalid date\",        \n          \"undefined\" \n          ) - ER_TRUNCATED_WRONG_VALUE: Incorrect date value: 'Invalid date' for column 'deadline' at row 1"
// }